...
const App = () => {
    ...
    const getTodos = () => {
        ...
        var config = {
            method: "get",
            url: "https://todolistappweb.herokuapp.com/get-all",
            headers: {
    ...
    const handleAddTodo = (todoName) => {
        if (todoName === "") {
            ...
            fetch("https://todolistappweb.herokuapp.com/save", {
                mode: "no-cors",
                method: "POST",
    ...
    const handleDeleteTodo = (mainTodo) => {
        fetch("https://todolistappweb.herokuapp.com/delete-by-id", {
            mode: "no-cors",
            method: "POST",
    ...
    const handleChangeStatus = (mainTodo) => {
        ...
        fetch("https://todolistappweb.herokuapp.com/update", {
            method: "POST",
